...
def test_create_once_return_false_for_second_event(user_event_repo, user_session):
...
def test_create_once_creates_two_events_for_different_sessions(user_event_repo, user_session, other_user_session):
    result_1 = user_event_repo.create_once(user_session.id, UserEventType.START_MESSAGE_SENT)
